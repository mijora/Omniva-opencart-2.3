      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-omnivalt" class="form-horizontal">
          ...
          <div class="form-group">
            ...
            <label class="" for="omnivalt_free_shipping_enabled">
              <input class=""  type="checkbox" name="omnivalt_free_shipping_enabled" <?php echo $omnivalt_free_shipping_enabled ? 'checked' : ''; ?> id="omnivalt_free_shipping_enabled"/>
              <?php echo $entry_free_shipping_enabled; ?></label>
            </div>
          </div>
          <div class="form-group required">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10" id="terminals">
              <?php echo ((isset($omnivalt_terminals) && is_array($omnivalt_terminals)) ? count($omnivalt_terminals) : 0); ?>
            </div>
          </div>
          <div class="form-group">
...
<script>
  document.addEventListener('DOMContentLoaded', initOmnivaAdmin);

  function initOmnivaAdmin() {
    var free_shipping_chkbox = document.getElementById('omnivalt_free_shipping_enabled');

    free_shipping_chkbox.addEventListener('change', function(e) {
      e.preventDefault();
      handleFreeShippingChkBox(this);
    });

    handleFreeShippingChkBox(free_shipping_chkbox);
  }

  function handleFreeShippingChkBox(chkBoxEl) {
    console.log(chkBoxEl.checked)
    if (chkBoxEl.checked) {
      showFreeShippingInputs();
    } else {
      hideFreeShippingInputs();
    }
  }

  function hideFreeShippingInputs() {
    $('input[name$="free"]').parent().parent().fadeOut();
  }

  function showFreeShippingInputs() {
    $('input[name$="free"]').parent().parent().fadeIn();
  }
</script>
